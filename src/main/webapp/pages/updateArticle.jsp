	...
	<div class="row first-row">
		...
		<div class="col-sm-10 corp">
			...
			<s:form action="/valideUpdateArticle" theme="css_xhtml">
				...
				<s:textfield name="article2.designation" label="Désignation"
					labelposition="left">
					<s:param>${article2.designation } </s:param>
				</s:textfield>
				<s:textfield name="article2.quantiteStock" label="Quantité Stock"
					labelposition="left">
				...
				<s:select list="lesCategories" label="Catégorie"
